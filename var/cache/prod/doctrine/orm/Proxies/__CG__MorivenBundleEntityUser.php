 ...
 */
class User extends \MorivenBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['ville' => '', 'lieu' => '', 'avatar' => '', 'timezone' => 'Europe/Berlin', 'language' => 'en', 'created' => NULL, 'updated' => NULL];
    ...
    {
        unset($this->ville, $this->lieu, $this->avatar, $this->timezone, $this->language, $this->created, $this->updated);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'ville', 'lieu', 'avatar', 'timezone', 'language', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles', 'created', 'updated'];
        }
    ...
    public function setVille(string $nature)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVille', [$nature]);

        return parent::setVille($nature);
    }
