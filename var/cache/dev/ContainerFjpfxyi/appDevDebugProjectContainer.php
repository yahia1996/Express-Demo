...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->fileMap = array(
            ...
            'moriven.mailer_service' => __DIR__.'/getMoriven_MailerServiceService.php',
            'moriven.ordre_repository' => __DIR__.'/getMoriven_OrdreRepositoryService.php',
            'moriven.user_repository' => __DIR__.'/getMoriven_UserRepositoryService.php',
            'moriven.verification_repository' => __DIR__.'/getMoriven_VerificationRepositoryService.php',
            ...
            'nelmio_api_doc.routes' => __DIR__.'/getNelmioApiDoc_RoutesService.php',
        ...
        $this->privates = array(
            ...
            'moriven.mailer_service' => true,
            'moriven.ordre_repository' => true,
            'moriven.user_repository' => true,
            'moriven.verification_repository' => true,
            'nelmio_api_doc.routes' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Qn8KfdH66W', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sIt8kDf8nt', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zEqJ1DPfRj', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sMkknLEsR8', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UIjOt8a3-R', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\app/../src/MorivenBundle/Resources'), 'moriven');
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\nelmio\\api-doc-bundle/Resources/views'), '!NelmioApiDoc');
        $instance->addPath(($this->targetDirs[3].'\\src\\MorivenBundle/Resources/views'), 'Moriven');
        $instance->addPath(($this->targetDirs[3].'\\src\\MorivenBundle/Resources/views'), 'FOSUser');
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'MorivenBundle' => array(
                    ...
                    'path' => ($this->targetDirs[3].'\\src\\MorivenBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MorivenBundle' => 'MorivenBundle\\MorivenBundle',
            ...
            'fos_user.model.user.class' => 'MorivenBundle\\Entity\\User',
